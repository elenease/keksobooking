...
* Студент: [Елена Петренко](https://up.htmlacademy.ru/javascript/14/user/4660).
...
[travis-image]: https://travis-ci.org/htmlacademy-javascript/4660-keksobooking.svg?branch=master
[travis-url]: https://travis-ci.org/htmlacademy-javascript/4660-keksobooking
